...
## 2026-08-13 タスクBE004002（一部）：ndlocr_cli ページ処理時間 DEBUG ログの追加

### 目的

backend BE004002「OCR 処理性能計測の実施」のうち、ユーザー指示により ocr-worker 側で 1 ページごとの OCR 処理時間を DEBUG ログで出力できるようにする。
...
## 2026-09-08 タスク OW006001：ページ単位進捗通知精度の向上（起票）
...
- 実施予定のコマンド:
  - `ocr-worker/docs/OW-TASKS.md` に OW006001 を追加
- 想定される結果や注意点:
  - 本タスクは起票のみとし、実装は別途フェーズにて実施する

### 【実施実績】

- 2026-09-08: `ocr-worker/docs/OW-TASKS.md` に OW006001 を追加し、ページ単位進捗通知の改善計画を記載
