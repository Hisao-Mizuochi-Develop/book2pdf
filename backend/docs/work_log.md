...
## 2026-08-12 結合テスト手順書の作成（タスク 006001）
...
# 全体計画書にリンクを追加（手動で docs/web-ocr-system-plan.md を編集）
...
- `backend/docs/tasks.md` にユースケース 006「結合テスト・運用ドキュメントの整備」とタスク 006001 を追加した
