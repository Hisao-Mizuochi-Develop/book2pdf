...
|  | 【実施結果】 |  |  |  |
|  | （未実施） |  |  |  |
| 003003 | PDF 白紙問題の修正と検証 | 2026-08-12 | 2026-08-12 | 不具合修正 |
|  | タスク詳細 |  |  |  |
|  | 【計画】 |  |  |  |
...
|  | 2026-08-12: 調査結果：テキスト位置のずれは XML のページサイズ（例：698×965）と PDF ページサイズ（664×942）が異なるにもかかわらずスケール変換が未実装なことが原因。タスク 003007 で修正 |  |  |  |
...
| タスクNO | タスクタイトル | タスク起票日付 | タスク完了日付 | タスク種別 |
|---|---|---|---|---|
| 003004 | PDF 透明テキスト配置ズレの調査 | 2026-08-12 | 2026-08-12 | 不具合調査 |
|  | タスク詳細 |  |  |  |
|  | 【計画】 |  |  |  |
...
|  | 2026-08-12: テキスト位置のずれは XML → PDF のスケール変換不足が原因。修正はタスク 003007 で実施 |  |  |  |
| 003005 | OCR 結果 XML の可視化検証 | 2026-08-12 | 2026-08-12 | 不具合調査 |
|  | タスク詳細 |  |  |  |
|  | 【計画】 |  |  |  |
...
|  | 2026-08-12: スケール変換が必要なことを確認。詳細な可視化スクリプト作成はタスク 003007 で実施 |  |  |  |
| 003006 | 特殊文字・フォント fallback の PDF 描画対応 | 2026-08-12 | 2026-08-12 | 不具合修正 |
|  | タスク詳細 |  |  |  |
|  | 【計画】 |  |  |  |
...
| 003007 | OCR 結果の座標スケーリングと認識精度の調査・修正 | 2026-08-12 | 2026-08-12 | 不具合調査・修正 |
|  | タスク詳細 |  |  |  |
|  | 【計画】 |  |  |  |
...
| 003008 | PDF 透明テキスト色の濃い緑化と OCR 精度改善調査 | 2026-08-12 | 2026-08-12 | 改善調査 |
|  | タスク詳細 |  |  |  |
|  | 【計画】 |  |  |  |
...
|  | 2026-08-12: **追加発見**: PDF テキストの Y 軸配置が上下逆転している。元画像の最下位置のテキストが PDF 上では最上位置に表示されており、XML 座標系（左上原点）から PDF 座標系（左下原点）への Y 座標変換が誤っていた。詳細はタスク 003009 で修正 |  |  |  |
...
| 003009 | PDF テキストY座標逆転問題の修正 | 2026-08-12 | 2026-08-12 | 不具合修正 |
|  | タスク詳細 |  |  |  |
|  | 【計画】 |  |  |  |
...
|  | 2026-08-12: 根拠調査・最終確認はタスク 003010 で実施 |  |  |  |
| 003010 | PDF テキストY座標逆転問題の根本調査と改修 | 2026-08-12 | 2026-08-12 | 不具合調査・修正 |
|  | タスク詳細 |  |  |  |
|  | 【計画】 |  |  |  |
...
| タスクNO | タスクタイトル | タスク起票日付 | タスク完了日付 | タスク種別 |
|---|---|---|---|---|
| 004001 | backend DEBUG ログ・計測処理の追加 | 2026-08-12 | 2026-08-12 | 機能実装 |
|  | タスク詳細 |  |  |  |
|  | 【計画】 |  |  |  |
...
| 004002 | アップロード済みファイルのユーザー明示的破棄機能の追加 | 2026-08-12 |  | 機能実装 |
|  | タスク詳細 |  |  |  |
|  | 【計画】 |  |  |  |
...
| タスクNO | タスクタイトル | タスク起票日付 | タスク完了日付 | タスク種別 |
|---|---|---|---|---|
| 005001 | ジョブ状態の SQLite 永続化 | 2026-08-11 |  | 機能実装 |
|  | タスク詳細 |  |  |  |
|  | 【計画】 |  |  |  |
...
| タスクNO | タスクタイトル | タスク起票日付 | タスク完了日付 | タスク種別 |
|---|---|---|---|---|
| 006001 | 進捗通知のポーリング方式対応 | 2026-08-11 |  | 機能実装 |
|  | タスク詳細 |  |  |  |
|  | 【計画】 |  |  |  |
