...
| ユースケースNo | タイトル |
|---|---|
| [BE001](#be001) | ZIP アーカイブをアップロードして OCR ジョブを開始する |
| [BE002](#be002) | OCR 処理の進捗をリアルタイムで確認する |
| [BE003](#be003) | OCR 完了後に検索可能 PDF をダウンロードする |
| [BE004](#be004) | 性能計測に必要な DEBUG ログ・計測処理を追加する |
| [BE005](#be005) | ジョブ状態を永続化して再起動後も復元する |
...
|---|---|---|---|
| [BE001001](#be001001) FastAPI プロジェクトの初期構成 | 2026-08-11 | 2026-08-11 | 設計 |
| [BE001002](#be001002) ZIP アップロード・展開機能の実装 | 2026-08-11 | 2026-08-11 | 機能実装 |
| [BE001003](#be001003) ndlocr_cli 連携の実装 | 2026-08-11 | 2026-08-11 | 機能実装 |
| [BE001004](#be001004) ocr-worker コンテナ連携の実装 | 2026-08-11 | 2026-08-11 | 機能実装 |

<a id="be001001"></a>
### BE001001 FastAPI プロジェクトの初期構成

<div align="right"><a href="#be001">タスク一覧へ↩︎</a></div>
...
<div align="right"><a href="#be002">タスク一覧へ↩︎</a></div>
...
| タスク | タスク起票日付 | タスク完了日付 | タスク種別 |
|---|---|---|---|
| [BE003001](#be003001) 検索可能 PDF 生成機能の実装 | 2026-08-11 | 2026-08-11 | 機能実装 |
| [BE003002](#be003002) 縦書き PDF 対応 | 2026-08-11 |  | 機能実装 |
| [BE003003](#be003003) PDF 白紙問題の修正と検証 | 2026-08-12 | 2026-08-12 | 不具合修正 |
| [BE003004](#be003004) PDF 透明テキスト配置ズレの調査 | 2026-08-12 | 2026-08-12 | 不具合調査 |
| [BE003005](#be003005) OCR 結果 XML の可視化検証 | 2026-08-12 | 2026-08-12 | 不具合調査 |
| [BE003006](#be003006) 特殊文字・フォント fallback の PDF 描画対応 | 2026-08-12 | 2026-08-12 | 不具合修正 |
| [BE003007](#be003007) OCR 結果の座標スケーリングと認識精度の調査・修正 | 2026-08-12 | 2026-08-12 | 不具合調査・修正 |
| [BE003008](#be003008) PDF 透明テキスト色の濃い緑化と OCR 精度改善調査 | 2026-08-12 | 2026-08-12 | 改善調査 |
| [BE003009](#be003009) PDF テキストY座標逆転問題の修正 | 2026-08-12 | 2026-08-12 | 不具合修正 |
| [BE003010](#be003010) PDF テキストY座標逆転問題の根本調査と改修 | 2026-08-12 | 2026-08-12 | 不具合調査・修正 |
| [BE003011](#be003011) PDF テキスト抽出時の異体字問題を解決する | 2026-08-12 |  | 不具合修正 |
| [BE003012](#be003012) `/ocr` エンドポイントの非同期化 | 2026-09-03 | 2026-09-03 | 不具合修正 |

<a id="be003001"></a>
### BE003001 検索可能 PDF 生成機能の実装

<div align="right"><a href="#be003">タスク一覧へ↩︎</a></div>
...
<a id="be003006"></a>
### BE003006 特殊文字・フォント fallback の PDF 描画対応
...
<a id="be003007"></a>
### BE003007 OCR 結果の座標スケーリングと認識精度の調査・修正
...
<a id="be003008"></a>
### BE003008 PDF 透明テキスト色の濃い緑化と OCR 精度改善調査
...
<a id="be003010"></a>
### BE003010 PDF テキストY座標逆転問題の根本調査と改修
...
<a id="be003011"></a>
### BE003011 PDF テキスト抽出時の異体字問題を解決する
...
| タスク | タスク起票日付 | タスク完了日付 | タスク種別 |
|---|---|---|---|
| [BE005001](#be005001) ジョブ状態の SQLite 永続化 | 2026-08-11 |  | 機能実装 |

<a id="be005001"></a>
### BE005001 ジョブ状態の SQLite 永続化

<div align="right"><a href="#be005">タスク一覧へ↩︎</a></div>
...
<div align="right"><a href="#be006">タスク一覧へ↩︎</a></div>
...
| タスク | タスク起票日付 | タスク完了日付 | タスク種別 |
|---|---|---|---|
| [BE007001](#be007001) FastAPI に CORS ミドルウェアを追加する | 2026-09-07 | 2026-09-07 | 機能実装 |

<a id="be007001"></a>
### BE007001 FastAPI に CORS ミドルウェアを追加する

<div align="right"><a href="#be007">タスク一覧へ↩︎</a></div>
...
| タスク | タスク起票日付 | タスク完了日付 | タスク種別 |
|---|---|---|---|
| [BE008001](#be008001) `test_generate_searchable_pdf_normalizes_variant_characters` の失敗修正 | 2026-09-07 | 2026-09-08 | 不具合修正 |

<a id="be008001"></a>
### BE008001 `test_generate_searchable_pdf_normalizes_variant_characters` の失敗修正

<div align="right"><a href="#be008">タスク一覧へ↩︎</a></div>
