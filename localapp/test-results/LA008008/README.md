# LA008008 画像結合 PDF 生成（OCR なし）自動テスト結果レポート
...
| 使用テストデータ | `test_cases/testdata/localapp/LA003006-backend-ocr-test/`（`002.png`, `003.png`, `004.png`） |
| OCR エンジン | なし（画像結合のみ） |
...
- 画像収集・ソート機能が `LA003006-backend-ocr-test/` の既存データに対して正しく動作する
