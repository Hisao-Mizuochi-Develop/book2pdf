...
| [LA006](#la006) | モダン GUI デザイン |
| [LA007](#la007) | 設定・永続化 |
| [LA008](#la008) | PDF作成（Backend API連携） |
...
|---|---|---|---|
| [LA001001 Tauri v2 + React + Vite プロジェクト scaffold 作成](#la001001) | 2026-08-15 | 2026-08-15 | 実装 |
| [LA001002 Rust 側依存クレートの選定・追加](#la001002) | 2026-08-15 | 2026-08-15 | 実装 |
| [LA001003 frontend 側依存の選定・追加](#la001003) | 2026-08-15 | 2026-08-15 | 実装 |
| [LA001004 開発・ビルド環境整備（tauri.conf.json / scripts 等）](#la001004) | 2026-08-15 | 2026-08-15 | 実装 |
...
| タスク | タスク起票日付 | タスク完了日付 | タスク種別 |
|---|---|---|---|
| [LA002001 画面キャプチャ方式調査・実装](#la002001) | 2026-08-15 | 2026-08-16 | 調査/実装 |
| [LA002002 アプリプロファイル管理 UI](#la002002) | 2026-08-15 | 2026-08-16 | 実装 |
| [LA002003 連続キャプチャ実行・進捗表示](#la002003) | 2026-08-15 | 2026-08-16 | 実装 |
| [LA002004 キャプチャ画像のフォルダ管理](#la002004) | 2026-08-15 | 2026-08-16 | 実装 |
| [LA002005 ウィンドウ指定キャプチャ＋コンテンツ領域自動トリミング](#la002005) | 2026-08-16 | 2026-08-17 | 実装（002007に統合） |
| [LA002006 ウィンドウ指定キャプチャ実装のコンパイルエラー修正](#la002006) | 2026-08-16 | 2026-08-16 | 不具合修正 |
| [LA002007 ウィンドウ指定キャプチャ実装（xcap crate 版）](#la002007) | 2026-08-16 | 2026-08-17 | 実装 |
| [LA002007-1 連続キャプチャバグ修正（MSE計算 & 最前面化）](#la002007-1) | 2026-08-16 | 2026-08-16 | 不具合修正 |
| [LA002007-2 プロファイルUI改善（デフォルト選択・表示・バリデーション）](#la002007-2) | 2026-08-16 | 2026-08-17 | 改善 |
| [LA002007-3 連続キャプチャ途中完了バグ修正（MSE同一ページ判定の猶予）](#la002007-3) | 2026-08-20 | 2026-08-20 | 不具合修正 |
| [LA002007 連続キャプチャの出力フォルダ指定とトリミング画面への引継ぎ](#la002007) | 2026-08-20 | 2026-08-21 | 実装 |
...
> - コミット: `LA002007-3: 連続キャプチャ途中完了バグ修正（MSE同一ページ判定の猶予）` (`bd1afd0`)
...
>     - `cd localapp && npm run build`: 成功（`tsc && vite build` ともにエラーなし）
>
<a id="la002009（将来タスク）ウィンドウ最前面化・クリック自動化"></a>
### LA002009（将来タスク）ウィンドウ最前面化・クリック自動化
...
| タスク | タスク起票日付 | タスク完了日付 | タスク種別 |
|---|---|---|---|
| [LA003001 PDF 選択・設定 UI](#la003001) | 2026-08-15 | 2026-08-19 | 実装 |
| [LA003002 PDF → 画像展開（Rust バックエンド）](#la003002) | 2026-08-15 | 2026-08-19 | 実装 |
| [LA003003 PDF 読込 進捗インジケーター表示不具合調査・修正](#la003003) | 2026-08-20 | 2026-08-20 | 不具合修正 |
| [LA003004 PDF 読込 Pdfium 二重初期化エラー修正](#la003004) | 2026-08-20 | 2026-08-20 | 不具合修正 |
| [LA003005 PDF 画面の出力フォルダ自動設定と完了後表示改善](#la003005) | 2026-08-21 | 2026-08-21 | 実装 |
| [LA003006 PDF → OCR 連携（localapp → backend API）](#la003006) | 2026-09-01 | 2026-09-03 | 実装 |
...
| タスク | タスク起票日付 | タスク完了日付 | タスク種別 |
|---|---|---|---|
| [LA004001 画像フォルダ読み込み・サムネイル一覧 UI](#la004001) | 2026-08-15 | 2026-08-18 | 実装 |
| [LA004002 Before/After プレビュー表示](#la004002) | 2026-08-15 | 2026-08-18 | 実装 |
| [LA004003 余白自動検出（Rust バックエンド）](#la004003) | 2026-08-15 |  | 実装 |
| [LA004004 手動余白調整 UI](#la004004) | 2026-08-15 |  | 実装 |
| [LA004005 トリミング一括実行・進捗表示](#la004005) | 2026-08-15 |  | 実装 |
...
| タスク | タスク起票日付 | タスク完了日付 | タスク種別 |
|---|---|---|---|
| [LA005001 ZIP アーカイブ化（Rust バックエンド）](#la005001) | 2026-08-15 | 2026-08-18 | 実装 |
| [LA005002 出力設定・ファイル名設定 UI](#la005002) | 2026-08-15 | 2026-08-18 | 実装 |
| [LA005003 タブ間自動連携](#la005003) | 2026-08-15 | 2026-08-18 | 実装 |
| [LA005004 ZIP 作成進捗インジケーター追加](#la005004) | 2026-08-20 | 2026-08-20 | 改善 |
...
| タスク | タスク起票日付 | タスク完了日付 | タスク種別 |
|---|---|---|---|
| [LA006001 デザインシステム定義](#la006001) | 2026-08-15 | 2026-08-16 | 実装 |
| [LA006002 サイドバー＋メインレイアウト実装](#la006002) | 2026-08-15 | 2026-08-15 | 実装 |
| [LA006003 ライトモード対応 + OS 設定連動](#la006003) | 2026-08-15 | 2026-08-16 | 実装 |
| [LA006004 アプリ名・サイドバー変更](#la006004) | 2026-08-15 | 2026-08-16 | 実装 |
...
| タスク | タスク起票日付 | タスク完了日付 | タスク種別 |
|---|---|---|---|
| [LA007001 アプリ設定ファイル管理](#la007001) | 2026-08-15 |  | 実装 |
| [LA007002 プロファイル・履歴の永続化](#la007002) | 2026-08-15 |  | 実装 |
...
| タスク | タスク起票日付 | タスク完了日付 | タスク種別 |
|---|---|---|---|
| [LA008001 ローカル画像収集・ZIPアーカイブ化コマンド](#la008001) | 2026-08-22 | 2026-09-01 | 実装 |
| [LA008002 Backend API連携 — ジョブ作成・アップロード・OCR実行](#la008002) | 2026-08-22 | 2026-09-01 | 実装 |
| [LA008003 Backend API連携 — ジョブ状態ポーリング・PDFダウンロード](#la008003) | 2026-08-22 | 2026-09-01 | 実装 |
| [LA008004 フロントエンド進捗インジケーター統合](#la008004) | 2026-08-22 | 2026-09-01 | 実装 |
| [LA008005 完了後「フォルダを開く」ボタン実装](#la008005) | 2026-08-22 | 2026-09-01 | 実装 |
| [LA008006 backend OCR 連携機能統合テスト](#la008006) | 2026-08-22 |  | 実装 |
| [LA008007 localapp 単体生成 技術調査・選定](#la008007) | 2026-09-03 |  | 調査 / 設計 |
| [LA008008 画像結合PDF生成の実装（OCRなし）](#la008008) | 2026-09-03 | 2026-09-04 | 実装 |
| [LA008009 OCRエンジン統合・検索可能PDF生成の実装](#la008009) | 2026-09-03 | 2026-09-04 | 実装 |
| [LA008010 Tauri invoke 引数修正・エンドツーエンド動作確認](#la008010) | 2026-09-03 | 2026-09-04 | 実装 / 統合テスト |
| [LA008011 OCR精度向上（Tesseract pre-processing / モデル選定）](#la008011) | 2026-09-04 |  | 改善調査 |
| [LA008012 透明テキストレイヤー・座標補正](#la008012) | 2026-09-04 |  | 不具合修正 |
