...
| ユースケースNo | タイトル |
|---|---|
| [LA001](#la001) | Tauri v2 プロジェクト初期化 |
| [LA002](#la002) | 画面キャプチャ |
| [LA003](#la003) | PDF 読込 |
| [LA004](#la004) | 画像トリミング |
| [LA005](#la005) | ZIP 出力・連携 |
| [LA006](#la006) | 設定管理 |
| [LA007](#la007) | OCR 実行・結果表示 |
| [LA008](#la008) | Rust 汎用モジュール整備 |
...
|---|---|---|---|
| [LA001001](#la001001) Tauri v2 + React + Vite プロジェクト scaffold 作成 | 2026-08-15 | 2026-08-15 | 実装 |
| [LA001002](#la001002) Rust 側依存クレートの選定・追加 | 2026-08-15 | 2026-08-15 | 実装 |
| [LA001003](#la001003) frontend 側依存の選定・追加 | 2026-08-15 | 2026-08-15 | 実装 |
| [LA001004](#la001004) 開発・ビルド環境整備（tauri.conf.json / scripts 等） | 2026-08-15 | 2026-08-15 | 実装 |
...
>>>>>>> feature/OT010005-task-md-format-unify
...
| タスク | タスク起票日付 | タスク完了日付 | タスク種別 |
|---|---|---|---|
| [LA002001](#la002001) 画面キャプチャ方式調査・実装 | 2026-08-15 | 2026-08-16 | 調査/実装 |
| [LA002002](#la002002) アプリプロファイル管理 UI | 2026-08-15 | 2026-08-16 | 実装 |
| [LA002003](#la002003) 連続キャプチャ実行・進捗表示 | 2026-08-15 | 2026-08-16 | 実装 |
| [LA002004](#la002004) キャプチャ画像のフォルダ管理 | 2026-08-15 | 2026-08-16 | 実装 |
| [LA002005](#la002005) ウィンドウ指定キャプチャ＋コンテンツ領域自動トリミング | 2026-08-16 | 2026-08-17 | 実装（002007に統合） |
| [LA002006](#la002006) ウィンドウ指定キャプチャ実装のコンパイルエラー修正 | 2026-08-16 | 2026-08-16 | 不具合修正 |
| [LA002007](#la002007) 連続キャプチャの出力フォルダ指定とトリミング画面への引継ぎ | 2026-08-16 | 2026-08-17 | 実装 |
| [LA002008](#la002008) 連続キャプチャバグ修正（MSE計算 & 最前面化）【バグ対応】 | 2026-08-16 | 2026-08-16 | 不具合修正 |
| [LA002009](#la002009) プロファイルUI改善（デフォルト選択・表示・バリデーション） | 2026-08-16 | 2026-08-17 | 改善 |
| [LA002010](#la002010) 連続キャプチャ途中完了バグ修正（MSE同一ページ判定の猶予） | 2026-08-20 | 2026-08-20 | 不具合修正 |
| [LA002011](#la002011) 連続キャプチャの出力フォルダ指定とトリミング画面への引継ぎ | 2026-08-20 | 2026-08-21 | 実装 |
| [LA002012](#la002012（将来タスク）ウィンドウ最前面化・クリック自動化) （将来タスク）ウィンドウ最前面化・クリック自動化 | | | 将来タスク |
...
> - LA002005 の実装内容（ウィンドウ指定キャプチャ＋コンテンツ領域自動トリミング）は LA002007（xcap crate 版）に引き継がれた
> - LA002005 と LA002007 の重複解消: LA002005 は LA002006 で全画面キャプチャ + `crop_insets` トリミングに後退し、ウィンドウ指定キャプチャの機能は LA002007 で完全実装された。`crop_insets` 機能自体は LA002006/LA002007 双方で使用されており、LA002005 の計画は実質的に LA002007 に統合されたと判断する
>
<a id="la002006"></a>
...
> - `npm run build`: ビルド成功（`tsc && vite build` ともにエラーなし）
> - ブランチ: `feature/LA002006-window-capture-compile-fix` → main にマージ（Fast-forward）
> - コミット: `ddd048b`
>
<a id="la002007"></a>
...
> - コミット: `LA002010: 連続キャプチャ途中完了バグ修正（MSE同一ページ判定の猶予）` (`bd1afd0`)
...
> - 2026-08-21: バグ修正（LA002011-1）— トリミング画面へのフォルダ引継ぎが機能しない問題
...
>     - `cd localapp && npm run build`: 成功（`tsc && vite build` ともにエラーなし）
>
<a id="la002012（将来タスク）ウィンドウ最前面化・クリック自動化"></a>
### LA002012（将来タスク）ウィンドウ最前面化・クリック自動化
...
|  | - コミット: `ddd048b` |  |  |  |
| LA002008 | ウィンドウ指定キャプチャ実装（xcap crate 版） | 2026-08-16 | 2026-08-20 | 実装 |
|  | タスク詳細 |  |  |  |
|  | 【計画】 |  |  |  |
|  | 1. 不具合の原因調査 |  |  |  |
|  | - `run_continuous_capture_loop()` 内の MSE 判定と `page_wait` のタイミングを確認 |  |  |  |
...
|  |  | 2026-08-16: 連続キャプチャバグ修正（MSE計算 & 最前面化） 不具合修正 |  |  |
|  |  | 2026-08-17: プロファイルUI改善（デフォルト選択・表示・バリデーション） 改善 |  |  |
|  |  | 2026-08-20: 連続キャプチャ途中完了バグ修正（MSE同一ページ判定の猶予） 不具合修正 |  |  |
...
| タスク | タスク起票日付 | タスク完了日付 | タスク種別 |
|---|---|---|---|
| [LA003001](#la003001) PDF 選択・設定 UI | 2026-08-15 | 2026-08-19 | 実装 |
| [LA003002](#la003002) PDF → 画像展開（Rust バックエンド） | 2026-08-15 | 2026-08-19 | 実装 |
| [LA003003](#la003003) PDF 読込 進捗インジケーター表示不具合調査・修正 | 2026-08-20 | 2026-08-20 | 不具合修正 |
| [LA003004](#la003004) PDF 読込 Pdfium 二重初期化エラー修正 | 2026-08-20 | 2026-08-20 | 不具合修正 |
| [LA003005](#la003005) PDF 画面の出力フォルダ自動設定と完了後表示改善 | 2026-08-21 | 2026-08-21 | 実装 |
| [LA003006](#la003006) PDF → OCR 連携（localapp → backend API） | 2026-09-01 | 2026-09-03 | 実装 |
...
| タスク | タスク起票日付 | タスク完了日付 | タスク種別 |
|---|---|---|---|
| [LA004001](#la004001) 画像フォルダ読み込み・サムネイル一覧 UI | 2026-08-15 | 2026-08-18 | 実装 |
| [LA004002](#la004002) Before/After プレビュー表示 | 2026-08-15 | 2026-08-18 | 実装 |
| [LA004003](#la004003) 余白自動検出（Rust バックエンド） | 2026-08-15 |  | 実装 |
| [LA004004](#la004004) 手動余白調整 UI | 2026-08-15 |  | 実装 |
| [LA004005](#la004005) トリミング一括実行・進捗表示 | 2026-08-15 |  | 実装 |
...
| タスク | タスク起票日付 | タスク完了日付 | タスク種別 |
|---|---|---|---|
| [LA005001](#la005001) ZIP アーカイブ化（Rust バックエンド） | 2026-08-15 | 2026-08-18 | 実装 |
| [LA005002](#la005002) 出力設定・ファイル名設定 UI | 2026-08-15 | 2026-08-18 | 実装 |
| [LA005003](#la005003) タブ間自動連携 | 2026-08-15 | 2026-08-18 | 実装 |
| [LA005004](#la005004) ZIP 作成進捗インジケーター追加 | 2026-08-20 | 2026-08-20 | 改善 |
...
| タスク | タスク起票日付 | タスク完了日付 | タスク種別 |
|---|---|---|---|
| [LA006001](#la006001) デザインシステム定義 | 2026-08-15 | 2026-08-16 | 実装 |
| [LA006002](#la006002) サイドバー＋メインレイアウト実装 | 2026-08-15 | 2026-08-15 | 実装 |
| [LA006003](#la006003) ライトモード対応 + OS 設定連動 | 2026-08-15 | 2026-08-16 | 実装 |
| [LA006004](#la006004) アプリ名・サイドバー変更 | 2026-08-15 | 2026-08-16 | 実装 |
...
| タスク | タスク起票日付 | タスク完了日付 | タスク種別 |
|---|---|---|---|
| [LA007001](#la007001) アプリ設定ファイル管理 | 2026-08-15 |  | 実装 |
| [LA007002](#la007002) プロファイル・履歴の永続化 | 2026-08-15 |  | 実装 |
...
| タスク | タスク起票日付 | タスク完了日付 | タスク種別 |
|---|---|---|---|
| [LA008001](#la008001) ローカル画像収集・ZIPアーカイブ化コマンド | 2026-08-22 | 2026-09-01 | 実装 |
| [LA008002](#la008002) Backend API連携 — ジョブ作成・アップロード・OCR実行 | 2026-08-22 | 2026-09-01 | 実装 |
| [LA008003](#la008003) Backend API連携 — ジョブ状態ポーリング・PDFダウンロード | 2026-08-22 | 2026-09-01 | 実装 |
| [LA008004](#la008004) フロントエンド進捗インジケーター統合 | 2026-08-22 | 2026-09-01 | 実装 |
| [LA008005](#la008005) 完了後「フォルダを開く」ボタン実装 | 2026-08-22 | 2026-09-01 | 実装 |
| [LA008006](#la008006) backend OCR 連携機能統合テスト | 2026-08-22 |  | 実装 |
| [LA008007](#la008007) localapp 単体生成 技術調査・選定 | 2026-09-03 |  | 調査 / 設計 |
| [LA008008](#la008008) 画像結合PDF生成の実装（OCRなし） | 2026-09-03 | 2026-09-04 | 実装 |
| [LA008009](#la008009) OCRエンジン統合・検索可能PDF生成の実装 | 2026-09-03 | 2026-09-04 | 実装 |
| [LA008010](#la008010) Tauri invoke 引数修正・エンドツーエンド動作確認 | 2026-09-03 | 2026-09-04 | 実装 / 統合テスト |
| [LA008011](#la008011) OCR精度向上（Tesseract pre-processing / モデル選定） | 2026-09-04 |  | 改善調査 |
| [LA008012](#la008012) 透明テキストレイヤー・座標補正 | 2026-09-04 |  | 不具合修正 |
