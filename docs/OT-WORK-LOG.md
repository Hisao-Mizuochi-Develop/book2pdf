...
## 2026-09-09 OT007003 `docs/SY-TASKS.md` の「識別子運用ルール」セクション削除と `.clinerules` 参照整理
...
- `docs/OT-TASKS.md` に `OT007003` を起票
...
## 2026-09-09 OT007004 各 `<識別子>-TASKS.md` の「タスク粒度の方針」を自識別子のみの記述に統一
...
- `docs/OT-TASKS.md` に `OT007004` を起票
