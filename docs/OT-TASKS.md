...
ユースケース
`frontend` タスク管理表のユースケース番号を整理する

<div align="right"><a href="#ユースケース一覧">ユースケース一覧へ↩︎</a></div>

| タスク | タスク起票日付 | タスク完了日付 | タスク種別 |
|---|---|---|---|
| [OT011001](#ot011001) `frontend/docs/FE-TASKS.md` の FE004 ユースケースを整理する（削除・FE005→FE004 繰上げ） | 2026-09-20 | 2026-09-20 | ドキュメント整理 |

<a id="ot011001"></a>
### OT011001 `frontend/docs/FE-TASKS.md` の FE004 ユースケースを整理する（削除・FE005→FE004 繰上げ）

<div align="right"><a href="#ot011">タスク一覧へ↩︎</a></div>

> 【計画】
> - `frontend/docs/FE-TASKS.md` から不要なユースケース FE004（`プロキシ環境でも進捗通知を受け取る`）とタスク FE004001 を削除する
> - 削除対象:
>   - ユースケース一覧テーブルの FE004 行
>   - FE004 ユースケースセクション（タスクテーブルと FE004001 詳細）
> - ユースケース番号の欠番を埋めるため、FE005（`frontend コンテナの健全性を維持する`）を FE004 に繰り上げ、FE005001 を FE004001 に変更する
> - `python scripts/lint-task-md.py` でパイプテーブル整合性を検証する
>
> 【実施結果】
...
> - 2026-09-20: ユースケース番号の欠番を埋めるため、FE005 を FE004 に繰り上げ、FE005001 を FE004001 に変更
>
...
| タスク | タスク起票日付 | タスク完了日付 | タスク種別 |
|---|---|---|---|
| [OT012001](#ot012001) 完了済み未記入タスクの棚卸し（BE006001・BE009001・OW002002・OW006001） | 2026-09-20 | 2026-09-20 | ドキュメント整理 |

<a id="ot012001"></a>
### OT012001 完了済み未記入タスクの棚卸し（BE006001・BE009001・OW002002・OW006001）

<div align="right"><a href="#ot012">タスク一覧へ↩︎</a></div>

> 【計画】
> - `backend/docs/BE-TASKS.md` の BE006001「進捗通知のポーリング方式対応」の【タスク完了日付】と【実施結果】を追記する
> - `backend/docs/BE-TASKS.md` の BE009001「backend→ocr-worker 同期 POST /ocr を非同期化し GET /result/{job_id} を追加する」の【タスク完了日付】と【実施結果】を追記する
> - `ocr-worker/docs/OW-TASKS.md` の OW002002「OCR 処理性能計測の実施」の【タスク完了日付】と【実施結果】を追記する
> - `ocr-worker/docs/OW-TASKS.md` の OW006001「ページ単位進捗通知精度の向上」の【タスク完了日付】と【実施結果】を追記する
> - 棚卸し対象 1: frontend の自動 SSE → polling フォールバック実装により、プロキシ環境でも進捗通知が受け取れる状態になっているが、BE006001 が未完了のままになっていた
> - 棚卸し対象 2: `ocr-worker/app/main.py` の `POST /ocr` 非同期化・`GET /result/{job_id}` 追加、`backend/app/services/ocr_engine.py` の非同期ポーリング化などにより BE009001 の目的は達成されているが、タスク管理表に未記入のままになっていた
> - 棚卸し対象 3: OW002002 は性能計測用 DEBUG ログ・計測処理が OW002001 で実装済みで、実質的に完了状態になっていたが、【タスク完了日付】が未記入だった
> - 棚卸し対象 4: OW006001 は SY002002 / SY002003 / FE002001 などでページ単位進捗通知の実装が完了していたが、【タスク完了日付】が未記入だった
> - `python scripts/lint-task-md.py` でパイプテーブル整合性を検証する
>
> 【実施結果】
> - 2026-09-20: `backend/docs/BE-TASKS.md` の BE006001 に【タスク完了日付】`2026-09-09` を記入
> - 2026-09-20: `backend/docs/BE-TASKS.md` の BE006001 【実施結果】に、frontend 自動 SSE → polling フォールバック実装の内容を追記
> - 2026-09-20: `backend/docs/BE-TASKS.md` の BE009001 に【タスク完了日付】`2026-09-16` を記入
> - 2026-09-20: `backend/docs/BE-TASKS.md` の BE009001 【実施結果】に、backend→ocr-worker 非同期化実装の内容を追記
> - 2026-09-20: `ocr-worker/docs/OW-TASKS.md` の OW002002 に【タスク完了日付】`2026-09-20` を記入
> - 2026-09-20: `ocr-worker/docs/OW-TASKS.md` の OW002002 【実施結果】に、OT012001 棚卸しとして完了扱いに更新したことを追記
> - 2026-09-20: `ocr-worker/docs/OW-TASKS.md` の OW006001 に【タスク完了日付】`2026-09-20` を記入
> - 2026-09-20: `ocr-worker/docs/OW-TASKS.md` の OW006001 【実施結果】に、OT012001 棚卸しとして完了扱いに更新し、実質的に SY002002 / SY002003 / FE002001 で実装済みであることを追記
> - 2026-09-20: `python scripts/lint-task-md.py` で `docs/OT-TASKS.md` / `backend/docs/BE-TASKS.md` / `ocr-worker/docs/OW-TASKS.md` のパイプテーブル整合性を確認（ALL PASS）
>
