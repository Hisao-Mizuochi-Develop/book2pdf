#!/bin/zsh
# OW003007: 追加前処理効果検証の OCR フルフロー手動実行用スクリプト
# 使い方: ./scripts/run_OW003007_ocr_manual.sh <pattern_name> <zip_file>
# 例: ./scripts/run_OW003007_ocr_manual.sh baseline_2x benchmark-ocr-OW003007-baseline-2x.zip
